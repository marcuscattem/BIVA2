...
4. Selecione a população de referência usando os filtros
5. Em tolerância, escolha elipse tradicional deslocada ou z-score centrado no zero
6. Em confiança, adicione elipses com média, DP, correlação e N
...
11. Exporte a elipse em PNG, o gráfico em PNG, CSV ou Excel editável
12. Ajuste manualmente os eixos, se precisar padronizar a escala dos gráficos
13. Use "Abrir na mista" para levar tolerance/confidence para a análise mista já carregada
...
- Erro padrão = DP/√N
- Entrada manual de elipses Classic ou Specific
- 141 populações de referência completas
...
✅ Filtros avançados (sexo, país, faixa etária)
...
✅ Export de planilha Excel editável (.xls) com população, elipses, medições e testes
...
- **Elipses de referência:** permite marcar várias elipses de confiança e comparar cada par como grupos inteiros, usando médias, variâncias, correlação e N da população de referência.
